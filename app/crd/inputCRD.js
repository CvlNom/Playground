  ...
  function drawProfile() {
    ...
    switch (selectedRadio) {
      case "option1":
        ...
        x3 =
          x0 -
          Math.sqrt(Math.pow(rR + eR, 2) - Math.pow(eR + gap + rR - hOp, 2));
        x4 =
          x0 +
          Math.sqrt(Math.pow(rR + eR, 2) - Math.pow(eR + gap + rR - hOp, 2));
      ...
      case "option2":
        ...
        ctx.fillText(
          rRate(ip, op).toFixed(1),
          spanX * 4 - spanX * 0.7,
          spanY + 30
        );
        ctx.fillText(
          (rR / scaleCanvas).toFixed(3),
          spanX * 5 - spanX * 0.7,
          spanY + 30
        );
        ctx.fillText(inputValues.input3, spanX * 6 - spanX * 0.7, spanY + 30);
        ctx.fillText(
          (rH / scaleCanvas).toFixed(3),
          spanX * 7 - spanX * 0.7,
          spanY + 30
        );
        ctx.fillText(
          (hOp / scaleCanvas).toFixed(3),
          spanX * 8 - spanX * 0.7,
          spanY + 30
        );
  ...
  return (
    <div className="pl-4 py-2">
      <div className="flex flex-row justify-stretch py-1">
        <div className="w-48">
          <label className="text-slate-500 text-sm mr-2.5">In Wire(IP):</label>
          <input
        ...
        <div className="w-48">
          <label className="text-slate-500 text-sm mr-2.5">Out Wire(OP):</label>
          <input
            className="w-16 border-gray-700 border text-center text-sm text-slate-600"
            type="number"
            name="input2"
      ...
      <div className="pl-4 pt-1 mt-4 w-96" id="radio">
