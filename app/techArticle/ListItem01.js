...
export default function ListItem01({ results }) {
  return (
          ...
          >
            ...
            <div className="flex flex-col ml-4 mt-4 text-blue-600 text-sm">
              ...
              <div className="flex flex-row justify-between ml-4 items-center">
                ...
                <div className="mx-20 p-1">
                  <Link
                    href={`/techArticle/edit/${results[i]._id}`}
              ...
              <div className="flex flex-col ml-4 text-slate-700 text-sm">
                <h4 className="text-blue-600">Short Review</h4>
                <textarea defaultValue={results[i].summary} className="w-[640px] h-[100px] p-2"/>
              </div>
            </div>
          </div>
        );
