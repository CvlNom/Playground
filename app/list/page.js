    ...
    return (
      ...
      >
        ...
        <main className="flex-grow order-2 bg-slate-200 pl-4 pt-2">
          <h3 className="text-slate-500 text-xl font-bold ml-0 mb-4">
            Forum - Post List
          </h3>
          <p className="text-slate-600 text-sm italic ml-10 mb-2">
              ...
              <div>
                {result.map((a, i) => {
                  return (
                    ...
                    >
                      <span className="w-24 text-slate-500 text-xs pl-0.5">
                        {result[i].userID}
                      </span>
                      <Link prefetch={false} href={`/detail/${result[i]._id}`}>
                        <h4 className="w-[620px] text-blue-600 text-sm">
                          {result[i].title}
                        </h4>
                      </Link>
                      <span className="w-16 text-slate-500 text-xs">
                        {result[i].writeDate.substring(0, 6)}
                      </span>
                  ...
                  <div className="pageBorder">
                    ...
                    {pageNumbers.map((pageNumber, index) => (
                      <Link
                        key={index}
                        className={
                          page === pageNumber ? "markPage" : "hoverPage"
                        }
        ...
        >
          <div className="m-4">
            <h4 className="text-red-600 text-2xl italic font-bold">
              Question?
            </h4>
            <h4 className="text-blue-600 text-2xl italic font-bold">
              Need Advice?
            </h4>
            <h4 className="text-orange-600 text-2xl italic font-bold">
              Share Experience?
            </h4>
            <h4 className="text-slate-600 text-xl font-semibold">
              Anything you think,
            </h4>
            <h4 className="text-slate-700 text-2xl font-bold mt-2">
              POST YOUR OPINION
            </h4>
          </div>
          ...
          <AD_side
            company={[
              ...
              "Consulting?",
              "(82)-010-8641-4609",
              "alexkwak24@gmail.com",
            ]}
            deal={[
              "FCW, Aluminum Plant",
              "Tube Forming & Filling",
              "Application of Cassette Roller Die",
            ]}
          />
        </aside>
      </div>
